...
sudo echo "Welcome to DoublexDemo - Bastion Host - VM Hostname: $(hostname)" > /var/www/html/index.html
CUSTOM_DATA  
}
...
# Resource-3 Azure Linux Machine -Bastion host
resource "azurerm_linux_virtual_machine" "baston_host_linuxvm" {
